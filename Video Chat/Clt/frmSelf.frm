...
If frmSelf.WindowState = vbMinimized Then
    bSend = True
    frmClt.Wsk1.SendData Chr$(6) '±¾µØÍ£Ö¹·¢ËÍÍ¼ÏóÐÅÏ¢ stop sending video
ElseIf frmSelf.WindowState = vbNormal Then
    If bSend Then
        bSend = False
        'ask if continue receiving video
        frmClt.Wsk1.SendData Chr$(7) 'Ñ¯ÎÊÔ¶³Ì¼ÆËã»úÊÇ·ñ¼ÌÐø½ÓÊÕÍ¼ÏóÐÅÏ¢
    End If
End If
End Sub
...
On Error Resume Next
frmClt.Wsk1.SendData Chr$(5) 'Í£Ö¹·¢ËÍÍ¼ÏóÐÅÏ¢ stop sending video
End Sub
